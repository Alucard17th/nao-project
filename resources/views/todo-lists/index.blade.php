                        ...
                        <div class="card">
                            <div class="card-header inline-block item-todolist">
                                ...
                                <div class="list-todolist">
                                    ...
                                    <ul>
                                        @foreach($projects as $client)
                                            @if ($client->step == 'visite technique')
                                            <li>
                                                <a href="{{ url('/dashboard/todo-list/'.$client->id) }}">
                                ...
                                <div class="list-todolist">
                                    ...
                                    <ul>
                                        @foreach($projects as $client)
                                            @if ($client->step == 'demande des accords')
                                            <li>
                                                <a href="{{ url('/dashboard/todo-list/'.$client->id) }}">
                                                    <strong>{{$client->firstname}} {{$client->lastname}}</strong>
                                                </a>
                                ...
                                <div class="list-todolist">
                                    ...
                                    <ul>
                                        @foreach($projects as $client)
                                            @if ($client->step == 'début installation')
                                            <li>
                                                <a href="{{ url('/dashboard/todo-list/'.$client->id) }}">
                                                    <strong>{{$client->firstname}} {{$client->lastname}}</strong>
                                                </a>
                                ...
                                <div class="list-todolist">
                                    ...
                                    <ul>
                                        @foreach($projects as $client)
                                            @if ($client->step == 'fin installation')
                                            <li>
                                                <a href="{{ url('/dashboard/todo-list/'.$client->id) }}">
                                                    <strong>{{$client->firstname}} {{$client->lastname}}</strong>
                                                </a>
